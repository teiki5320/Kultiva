...
const List<PoussidexBadge> allBadges = <PoussidexBadge>[
  ...
  PoussidexBadge(
      ...
      emoji: '🌱',
      name: 'Premier pas',
      description: 'Choisir un starter.',
      tier: MedalTier.bronze),
  PoussidexBadge(
      id: 'named',
      emoji: '🎭',
      name: 'Baptisé',
      description: 'Donner un nom à ton Tamassi.',
      tier: MedalTier.bronze),
  PoussidexBadge(
      id: 'first_water',
      emoji: '💧',
      name: 'Baptême d\'eau',
      description: 'Premier arrosage.',
      tier: MedalTier.bronze),
  PoussidexBadge(
      id: 'first_fertilize',
      emoji: '🌿',
      name: 'Premier engrais',
      description: 'Première fertilisation.',
      tier: MedalTier.bronze),
  PoussidexBadge(
      id: 'first_pet',
      emoji: '👋',
      name: 'Ami',
      description: 'Premier bonjour à ton Tamassi.',
      tier: MedalTier.bronze),
  PoussidexBadge(
      id: 'first_challenge',
      emoji: '📸',
      name: '1er cliché',
      description: 'Compléter ton tout premier défi.',
      tier: MedalTier.bronze),
  PoussidexBadge(
      id: 'streak_3',
      emoji: '🔥',
      name: 'Régulier',
      description: '3 jours de connexion d\'affilée.',
      tier: MedalTier.bronze),
  PoussidexBadge(
      id: 'morning',
      emoji: '☀️',
      name: 'Matinal',
      description: 'Une connexion entre 6h et 9h.',
      tier: MedalTier.bronze),
  PoussidexBadge(
      id: 'night',
      emoji: '🌙',
      name: 'Nocturne',
      description: 'Une connexion entre 22h et 2h.',
      tier: MedalTier.bronze),
  PoussidexBadge(
      id: 'explorer',
      emoji: '📱',
  ...
  PoussidexBadge(
      ...
      emoji: '💪',
      name: 'Arroseur',
      description: '5 arrosages au total.',
      tier: MedalTier.bronze),
  ...
  PoussidexBadge(
      id: 'water_20',
      emoji: '💦',
      name: 'Arrosoir d\'argent',
      description: '20 arrosages cumulés.',
      tier: MedalTier.silver),
  PoussidexBadge(
      id: 'fertilize_20',
      emoji: '🌾',
      name: 'Engrais argent',
      description: '20 fertilisations cumulées.',
      tier: MedalTier.silver),
  PoussidexBadge(
      id: 'pet_20',
      emoji: '💕',
      name: 'BFF',
      description: '20 bonjours cumulés.',
      tier: MedalTier.silver),
  PoussidexBadge(
      id: 'challenges_5',
      emoji: '📸',
      name: 'Photographe',
      description: '5 défis complétés.',
      tier: MedalTier.silver),
  PoussidexBadge(
      id: 'streak_7',
      emoji: '🔥',
  ...
  PoussidexBadge(
      ...
      emoji: '🦉',
      name: 'Noctambule',
      description: '5 connexions entre 22h et 2h.',
      tier: MedalTier.silver),
  PoussidexBadge(
      id: 'morning_5',
      emoji: '☕',
      name: 'Lève-tôt',
      description: '5 connexions entre 6h et 9h.',
      tier: MedalTier.silver),
  PoussidexBadge(
      id: 'rain_login',
      emoji: '🌧️',
  ...
  PoussidexBadge(
      id: 'visits_5',
      emoji: '🦔',
      name: 'Collectionneur d\'amis',
      description: 'Recevoir 5 visites d\'amis.',
      tier: MedalTier.silver),
  PoussidexBadge(
      id: 'trio_15',
      emoji: '🌟',
  ...
  PoussidexBadge(
      ...
      emoji: '🌿',
      name: 'Engrais or',
      description: '100 fertilisations cumulées.',
      tier: MedalTier.gold),
  PoussidexBadge(
      id: 'challenges_15',
      emoji: '📸',
      name: 'Artiste',
      description: '15 défis complétés.',
      tier: MedalTier.gold),
  PoussidexBadge(
      id: 'streak_30',
      emoji: '🔥',
      name: 'Streak 30',
      description: '30 jours de connexion d\'affilée.',
      tier: MedalTier.gold),
  PoussidexBadge(
      id: 'visits_10',
      emoji: '🦋',
      name: 'Sociable',
      description: 'Recevoir 10 visites d\'amis.',
      tier: MedalTier.gold),
  PoussidexBadge(
      id: 'all_bronze_challenges',
      emoji: '🏆',
      name: 'Bronze complet',
      description: 'Tous les défis bronze (15).',
      tier: MedalTier.gold),
  PoussidexBadge(
      id: 'all_silver_challenges',
      emoji: '🥈',
      name: 'Argent complet',
      description: 'Tous les défis argent (15).',
      tier: MedalTier.gold),
  PoussidexBadge(
      id: 'four_seasons',
      emoji: '🌍',
  ...
  PoussidexBadge(
      ...
      description: 'Tous les 50 défis complétés.',
      tier: MedalTier.shiny),
  PoussidexBadge(
      id: 'streak_100',
      emoji: '🔥',
      ...
      tier: MedalTier.shiny),
  PoussidexBadge(
      id: 'all_gold_challenges',
      emoji: '👑',
      name: 'Or complet',
      description: 'Tous les défis or (13).',
      tier: MedalTier.shiny),
  PoussidexBadge(
      id: 'all_shiny_challenges',
      emoji: '💎',
      name: 'Shiny complet',
      description: 'Tous les défis shiny (7).',
      tier: MedalTier.shiny),
  PoussidexBadge(
      id: 'veteran_50',
      emoji: '🎖️',
  ...
  PoussidexBadge(
      ...
      emoji: '🦄',
      name: 'Rare',
      description: 'Débloquer 40 badges.',
      tier: MedalTier.shiny),
  PoussidexBadge(
      id: 'ultimate',
      emoji: '🏅',
